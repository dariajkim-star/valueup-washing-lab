...
// 기전도 확인했다. M&A 산식은 EV/EBIT·EBIT마진 기반인데 은행·보험 재무제표에는 그
// 개념이 성립하지 않는다(ebit_margin 보유: 은행 0/3 · 보험 0/5 vs 지주 26/38 · 비금융 265/292).
      ...
      return (
        <div className="flex flex-col items-end gap-0.5">
          ...
          <span
            ...
            title="M&A 스코어는 EV/EBIT·EBIT마진 기반인데 은행·보험 재무제표에는 그 개념이 성립하지 않는다. 지주회사·증권사는 여기 해당하지 않는다(정상 산출 대상)."
          >
            은행·보험
          </span>
        </div>
